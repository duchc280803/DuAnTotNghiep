...
public class SanPhamGiamGiaController {
    ...
    @GetMapping("show")
    public ResponseEntity<List<loadsanpham_not_login>> getAllSanPhamGiamGia() {
...
//        return new ResponseEntity<>(spGiamGiaRepository.getNamePriceImageByIdSanPham(idsanpham), HttpStatus.OK);
    }
